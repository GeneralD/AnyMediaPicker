...
public extension Reactive where Base: UICollectionView {
	...
	func reloadCells<S: Sequence, Cell: UICollectionViewCell, O: ObservableType>(_: Cell.Type, canMove: Bool = false) -> (_ _: O) -> Disposable where O.Element == S, Cell: Reusable & Configurable, Cell.Model == S.Iterator.Element {
	{ source in
		source
